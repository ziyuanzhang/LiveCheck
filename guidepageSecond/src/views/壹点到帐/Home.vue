  ...
  <div class="home">
    ...
    <div class="middle">
      ...
      <div class="protocol-con">
        ...
        <p class="txt">
          我已阅读并同意
          <a class="link" href="http://czmaosheng.cn/ydzcxy.pdf"
            >《壹点到账用户协议》</a
          >
          与
          <a class="link" href="http://czmaosheng.cn/ydysxy.pdf"
            >《隐私协议》</a
          >
        </p>
      </div>
            ...
            if (res.data && res.data.status == "0") {
              if (this.$utls.isAndroid()) {
                window.location.href =
                  "https://test-1255867289.cos.ap-shanghai.myqcloud.com/apk/yidian.apk";
              } else {
                window.location.href =
